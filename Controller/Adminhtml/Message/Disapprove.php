...
class Disapprove extends \EVGV\GuestBook\Controller\Adminhtml\Message
{
    /**
    ...
    public function execute()
    {
        ...
        if ($id) {
            try {
                ...
                $model->setData(MessageInterface::STATUS, Status::STATUS_DECLINED);

                $this->messageRepository->save($model);

                $this->messageManager->addSuccessMessage(__('You disapproved the Message.'));
        ...
        $this->messageManager->addErrorMessage(__('We can\'t find a message to disapprove.'));
